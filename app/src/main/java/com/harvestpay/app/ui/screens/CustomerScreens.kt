...
fun CustomerProfileScreen(
    ...
    LazyColumn(Modifier.padding(horizontal = 16.dp), verticalArrangement = Arrangement.spacedBy(12.dp)) {
        ...
        item {
            MetricGrid(
                listOf(
                    ...
                    "Registered Bigha" to formatBigha(summary.fields.sumOf { it.sizeBigha }),
        ...
        when (tab) {
            ...
            1 -> {
                if (summary.work.isEmpty()) item { EmptyState("No work history", "Record a ploughing job for this customer.") }
                    ...
                    WorkHistoryCard(
                        ...
                        onWhatsApp = { ReceiptGenerator.share(context, ReceiptGenerator.from(work, settings), whatsapp = true) },
            ...
            2 -> {
                if (summary.payments.isEmpty()) item { EmptyState("No payments", "Recorded payments will form the customer ledger.") }
    ...
    Card(Modifier.fillMaxWidth()) {
        Column(Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(7.dp)) {
            ...
            Row(Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.End) {
                IconButton(onClick = onWhatsApp) { Icon(Icons.Outlined.Chat, "Share receipt on WhatsApp") }
